...
public class Closet extends GameObject{
    ...
    String [] commands = {"turnon", "flush", "opencistern"};
    String [] answers = {"You turn on the lights. Suddenly you see a great amount of spiders and webs around you. You decide to turn the lights off again.", "The toilet gets flushed. The smell disappears. You feel much better now.", "You open the cistern and see a key inside."};
